...
struct RestasViewEn: View {
                    ...
                    VStack(spacing: 8) {
                        ...
                        HStack(spacing: 8) {
                            ...
                            Picker("Level", selection: $level){
                                ForEach(RestasLevel.allCases, id: \.self) { lvl in
    ...
    private func levelText(_ level: RestasLevel) -> String {
        switch level {
    ...
    private func modeText(_ mode: RestasMode) -> String {
        switch mode {
        case .sin: return "No borrowing"
        case .con: return "With borrowing"
        }
    }
        ...
        ZStack(alignment: .top) {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // TEXTO PRINCIPAL
                    Text("""
                    Subtractions appear on the screen. The first one (blue) is active. Enter the result.
                    ...
                    // ⏱️ RECUADRO
                    Text("⏱️ The game ends after 60 seconds or when there are 10 operations on the screen.")
                        .font(.footnote)
                        .fontWeight(.semibold)
                        .foregroundColor(.white)
                        .multilineTextAlignment(.center)
