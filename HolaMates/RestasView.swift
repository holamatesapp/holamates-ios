                    ...
                    VStack(spacing: 8) {
                        ...
                        VStack(spacing: 0) {
                            ...
                            Picker("", selection: $level) {
                                Text("1").tag(RestasLevel.initLevel)
                                Text("2").tag(RestasLevel.easy)
                                Text("3").tag(RestasLevel.normal)
                                Text("4").tag(RestasLevel.hard)
                            }
    ...
    private func randOp() -> SubtractionOp {
        ...
        if level == .hard {
            repeat {
                ...
                b = Int.random(in: 1...9)
                a = b + result
            } while a % 10 >= b   // 🔴 CON llevada
        } else {
            repeat {
                result = Int.random(in: 1...9)
                b = Int.random(in: 1...9)
                a = b + result
            } while a % 10 < b   // 🟢 SIN llevada
        }
