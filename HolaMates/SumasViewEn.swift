        ...
        ZStack(alignment: .top) {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // TEXTO PRINCIPAL
                    Text("""
    Additions appear on the screen. The first one (blue) is active. Enter the result.
...
private func levelText(_ level: SumasLevel) -> String {
    switch level {
...
private func modeText(_ mode: SumasMode) -> String {
    switch mode {
    case .sin: return "No carrying"
    case .con: return "With carrying"
    }
}
